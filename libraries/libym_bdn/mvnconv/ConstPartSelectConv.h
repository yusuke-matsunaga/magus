#ifndef LIBYM_BDN_MVNCONV_CONSTPARTSELECTCONV_H
#define LIBYM_BDN_MVNCONV_CONSTPARTSELECTCONV_H

/// @file libym_bdn/mvnconv/ConstPartSelectConv.h
...
#endif // LIBYM_BDN_MVNCONV_CONSTPARTSELECTCONV_H
