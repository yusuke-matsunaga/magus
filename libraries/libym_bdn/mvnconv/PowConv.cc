...
/// @file libym_bdn/mvnconv/PowConv.cc
/// @brief PowConv の実装クラス
...
bool
PowConv::operator()(const MvNode* node,
		    BdNetwork& bdnetwork,
		    MvnBdnMap& nodemap)
{
  if ( node->type() == MvNode::kPow ) {
    cerr << "Converter for power is not implemented" << endl;
#if 0
