...
/// @file CellLatchPosArray.cc
/// @brief CellLatchPosArray の実装ファイル
...
// @brief コンストラクタ
CellLatchPosArray::CellLatchPosArray() :
  mData(0U)
{
}

// @brief シグネチャを指定するコンストラクタ
CellLatchPosArray::CellLatchPosArray(ymuint sig) :
  mData(sig)
{
}
...
// @brief シグネチャを返す．
ymuint
CellLatchPosArray::signature() const
{
  return mData;
}
...
// @brief データ入力のピン番号を返す．
ymuint
CellLatchPosArray::data_pos() const
{
...
ymuint
CellLatchPosArray::enable_pos() const
{
...
ymuint
CellLatchPosArray::enable_sense() const
{
...
bool
CellLatchPosArray::has_enable() const
{
...
ymuint
CellLatchPosArray::clear_pos() const
{
...
ymuint
CellLatchPosArray::clear_sense() const
{
...
bool
CellLatchPosArray::has_clear() const
{
...
ymuint
CellLatchPosArray::preset_pos() const
{
...
// @retval 2 Low sensitive
ymuint
CellLatchPosArray::preset_sense() const
{
...
bool
CellLatchPosArray::has_preset() const
{
...
// @brief 否定出力のピン番号を返す．
ymuint
CellLatchPosArray::iq_pos() const
{
...
void
CellLatchPosArray::set_signature(ymuint sig)
{
  mData = sig;
}
...
void
CellLatchPosArray::set(ymuint data_pos,
		       ymuint enable_pos,
		       ymuint enable_sense,
		       ymuint clear_pos,
		       ymuint clear_sense,
