#ifndef LIBYM_LOGIC_SAT_YMSAT_SATREASON_H
#define LIBYM_LOGIC_SAT_YMSAT_SATREASON_H

/// @file libym_logic/sat/ymsat/SatReason.h
...
#endif // LIBYM_LOGI_SAT_YMSAT_SATREASON_H
