#ifndef LIBYM_MVN_CONV_CONSTPARTSELECTCONV_H
#define LIBYM_MVN_CONV_CONSTPARTSELECTCONV_H

/// @file libym_mvn/conv/ConstPartSelectConv.h
...
#endif // LIBYM_MVN_CONV_CONSTPARTSELECTCONV_H
