...
/// @file libym_mvnbdnconv/MultConv.cc
...
bool
MultConv::operator()(const MvnNode* node,
		     BdNetwork& bdnetwork,
		     MvnBdnMap& nodemap)
{
  if ( node->type() == MvnNode::kMult ) {
    cerr << "Converter for multiplication is not implemented" << endl;
#if 0
