#ifndef LIBYM_SAT_YMSAT_YMSAT_H
#define LIBYM_SAT_YMSAT_YMSAT_H

/// @file libym_sat/YmSat.h
/// @brief YmSat のヘッダファイル
/// @author Yusuke Matsunaga (松永 裕介)
///
/// $Id: YmSat.h 2274 2009-06-10 07:45:29Z matsunaga $
///
