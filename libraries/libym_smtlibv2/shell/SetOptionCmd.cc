...
/// @file SetOptionCmd.cc
/// @brief SetOptionCmd の実装ファイル
...
// @return 実行結果を返す．
const SmtLibNode*
SetOptionCmd::exec(const SmtLibNode* arg_top)
{
  // このコマンドは1つか2つの引数をとる．
  if ( arg_top == NULL ||
  ...
  return mgr()->set_option(arg_top->value(), attr_val);
