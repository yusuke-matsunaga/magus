 ...
 */
void
sm_row_remove_element(sm_row* prow,
		      sm_element* p)
{
    dll_unlink(p, prow->first_col, prow->last_col,
			next_col, prev_col, prow->length);
