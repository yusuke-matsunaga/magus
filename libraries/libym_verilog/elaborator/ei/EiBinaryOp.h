#ifndef LIBYM_VERILOG_ELB_IMPL_EIBINARYOP_H
#define LIBYM_VERILOG_ELB_IMPL_EIBINARYOP_H

/// @file libym_verilog/elb_impl/EiBinaryOp.h
...
#endif // LIBYM_VERILOG_ELB_IMPL_EIBINARYOP_H
