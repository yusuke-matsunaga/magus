...
//////////////////////////////////////////////////////////////////////
/// @class EiParamBitSelect EiBitSelect.h "EiBitSelect.h"
/// @brief ビット選択付きのプライマリ式を表すクラス
//////////////////////////////////////////////////////////////////////
class EiParamBitSelect :
  public EiExprBase1
{
  friend class EiFactory;
...
private:
  ...
  /// @param[in] obj 本体のオブジェクト
  /// @param[in] bit_index ビット選択式
  EiParamBitSelect(const PtBase* pt_expr,
		   ElbParameter* obj,
		   ElbExpr* bit_index);
...
//////////////////////////////////////////////////////////////////////
/// @class EiArrayElemBitSelect EiBitSelect.h "EiBitSelect.h"
/// @brief ビット選択付きの配列要素のプライマリ式を表すクラス
//////////////////////////////////////////////////////////////////////
class EiArrayElemBitSelect :
...
private:
  ...
  /// @param[in] bit_index ビット選択式
  EiArrayElemBitSelect(const PtBase* pt_expr,
		       ElbDeclArray* obj,
