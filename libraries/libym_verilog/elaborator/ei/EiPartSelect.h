#ifndef LIBYM_VERILOG_ELB_IMPL_EIPARTSELECT_H
#define LIBYM_VERILOG_ELB_IMPL_EIPARTSELECT_H

/// @file libym_verilog/elb_impl/EiPartSelect.h
...
//////////////////////////////////////////////////////////////////////
/// @class EiParamPartSelectPart EiPartSelect.h "EiPartSelect.h"
/// @brief パート選択付きのプライマリ式を表すクラス
//////////////////////////////////////////////////////////////////////
...
private:
  ...
  /// @param[in] index1, index2 パート選択式
  /// @param[in] index1_val, index2_val パート選択式の値
  EiParamPartSelect(const PtBase* pt_expr,
		    ElbParameter* obj,
		    ElbExpr* index1,
		    ElbExpr* index2,
		    int index1_val,
...
//////////////////////////////////////////////////////////////////////
/// @class EiArrayElemPrimaryPart EiPartSelect.h "EiPartSelect.h"
/// @brief パート選択付きの配列要素のプライマリ式を表すクラス
//////////////////////////////////////////////////////////////////////
class EiArrayElemPartSelect :
...
private:
  ...
  /// @param[in] index1, index2 パート選択式
  /// @param[in] index1_val, index2_val パート選択式の値
  EiArrayElemPartSelect(const PtBase* pt_expr,
			ElbDeclArray* obj,
...
#endif // LIBYM_VERILOG_ELB_IMPL_EIPARTSELECT_H
