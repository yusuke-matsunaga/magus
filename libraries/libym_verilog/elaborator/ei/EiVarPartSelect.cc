...
// @note それ以外では 0 を返す．
int
EiParamPlusPartSelect::left_range_val() const
{
  return right_range_val() + range_width_val() - 1;
}
...
// @note それ以外では 0 を返す．
int
EiParamMinusPartSelect::left_range_val() const
{
  return right_range_val() - range_width_val() + 1;
}
...
// @brief 範囲指定の時に true を返す．
bool
EiArrayElemVarPartSelect::is_partselect() const
{
  return true;
}
...
// @note それ以外では NULL を返す．
const VlExpr*
EiArrayElemVarPartSelect::right_range() const
{
  return mBase;
}
...
// @note それ以外では 0 を返す．
int
EiArrayElemVarPartSelect::right_range_val() const
{
  int ans;
  if ( mBase->eval_int(ans) ) {
    return ans;
...
// @note それ以外では NULL を返す．
const VlExpr*
EiArrayElemVarPartSelect::range_width() const
{
  return mRange;
}
...
// @note それ以外では 0 を返す．
int
EiArrayElemVarPartSelect::range_width_val() const
{
  return mRangeVal;
}
...
EiArrayElemVarPartSelect::set_scalar(tVpiScalarVal v)
{
  ...
  if ( eval_index() ) {
    decl_array()->set_bitselect(mIndexValList, right_range_val(), v);
  }
}
...
// @note それ以外では 0 を返す．
int
EiArrayElemPlusPartSelect::left_range_val() const
{
  return right_range_val() + range_width_val() - 1;
}
...
// @note それ以外では 0 を返す．
int
EiArrayElemMinusPartSelect::left_range_val() const
{
  return right_range_val() - range_width_val() + 1;
}
