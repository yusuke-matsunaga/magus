#ifndef LIBYM_VERILOG_ELABORATOR_INCLUDE_ELBGENVAR_H
#define LIBYM_VERILOG_ELABORATOR_INCLUDE_ELBGENVAR_H
...
#endif // LIBYM_VERILOG_ELABORATOR_INCLUDE_ELBGENVAR_H
