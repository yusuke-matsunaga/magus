...
private:
  ...
  gen_back_trace(
    ...
    const MapRecord& record, ///< [in] マッピング結果
    BnNetwork& mapnetwork    ///< [out] マッピング結果を格納するネットワーク
  );
