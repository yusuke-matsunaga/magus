...
### @file sbjlatch.pxi
### @brief sbjlatch の cython インターフェイス
### @author Yusuke Matsunaga (松永 裕介)
###
### Copyright (C) 2018 Yusuke Matsunaga
### All rights reserved.

### @brief SbjLatch の Python バージョン
cdef class SbjLatch :
    ...
    ### @brief 初期化
    def __init__(self, int id, int data_input, int enable, int data_output, int clear = -1, int preset = -1 ) :
        self.__id = id
