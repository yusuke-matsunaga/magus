...
/// @file magus/cellmap/Conv2SbjCmd.cc
/// @brief Conv2SbjCmd の実装ファイル
/// @author Yusuke Matsunaga (松永 裕介)
///
/// $Id: Conv2SbjCmd.cc 2507 2009-10-17 16:24:02Z matsunaga $
///
...
Conv2SbjCmd::cmd_proc(TclObjVector& objv)
{
  ...
  try {
    ...
    BNetwork& src_network = *cur_nethandle()->bnetwork();
