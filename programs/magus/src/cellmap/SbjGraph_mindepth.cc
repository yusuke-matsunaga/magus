...
/// @file magus/cellmap/SbjGraph_mindepth.cc 
/// @brief SbjGraph の実装ファイル
/// @author Yusuke Matsunaga (松永 裕介)
///
/// $Id: SbjGraph_mindepth.cc 1978 2009-02-06 12:29:16Z matsunaga $
///
...
void
SbjGraph::get_min_depth(size_t k) const
{
