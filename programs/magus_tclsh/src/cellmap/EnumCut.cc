...
/// @file magus/cellmap/EnumCut.cc 
/// @brief EnumCut の実装ファイル
/// @author Yusuke Matsunaga (松永 裕介)
///
/// $Id: EnumCut.cc 1978 2009-02-06 12:29:16Z matsunaga $
///
		    ...
		    EnumCutOp* op)
{
  ...
  mInodeStack = new size_t[sbjgraph.n_lnodes()];
  ...
  for (vector<SbjNode*>::const_iterator p = node_list.begin();
    ...
    for (size_t i = 0; i < mMarkedNodesLast; ++ i) {
...
EnumCut::enum_recur()
{
  if ( frontier_is_empty() ) {
    ...
    size_t old_input_pos = mInputPos;
    bool recur = true;
