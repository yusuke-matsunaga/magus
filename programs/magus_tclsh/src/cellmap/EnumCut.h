#ifndef MAGUS_CELLMAP_ENUMCUT_H
#define MAGUS_CELLMAP_ENUMCUT_H

/// @file magus/cellmap/EnumCut.h 
/// @brief EnumCut のヘッダファイル
/// @author Yusuke Matsunaga (松永 裕介)
///
/// $Id: EnumCut.h 1978 2009-02-06 12:29:16Z matsunaga $
///
...
private:
  ...
  public:
    ...
    /// @note pos < 20
    bool
    edge_mark(size_t pos) const;

    /// @brief pos 番めの枝のマークを付ける．
    void
    set_edge_mark(size_t pos);

    /// @brief pos 番めの枝のマークを消す．
    void
    clear_edge_mark(size_t pos);
...
inline
bool
EnumCut::NodeTemp::edge_mark(size_t pos) const
{
...
inline
void
EnumCut::NodeTemp::set_edge_mark(size_t pos)
{
  mMarks |= (32U << pos);
}
...
inline
void
EnumCut::NodeTemp::clear_edge_mark(size_t pos)
{
  mMarks &= ~(32U << pos);
}
