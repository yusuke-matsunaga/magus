...
// @brief キューに入れる．
void
MapState::put_queue(const SbjNode* node)
{
...
// @brief マッピング情報をコピーする．
void
MapState::copy_to(MapRecord& maprecord)
{
